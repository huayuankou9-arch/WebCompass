    ...
    <section id="top" className="relative overflow-hidden pt-28">
      ...
      <div className="container pb-16">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-balance text-lg text-muted-foreground md:text-2xl">{subtitle}</p>
          <p className="mx-auto mt-5 max-w-3xl text-pretty leading-relaxed text-muted-foreground">{tagline}</p>
